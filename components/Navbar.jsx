...
const Navbar = ({isDarkMode, setIsDarkMode}) => {
    ...
    return (
        ...
        <div className='fixed top-0 right-0 w-11/12 -z-10 translate-y-[-80%] dark:hidden'>
            ...
            <nav className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-3 flex items-center justify-between
                 z-50 ${isScroll ? "bg-lightBackground bg-opacity-50 backdrop-blur-lg shadow-sm dark:bg-darkBackground dark:shadow-lg" : ""}`}>
                <a href="#top">
                    <Image src={ isDarkMode ? assets.logo_dark : assets.logo} alt='' className='w-28 cursor-pointer mr-14' />
                </a>

            <ul className={`hidden md:flex items-center gap-6 lg:gap-8 rounded-full px-12 py-3
                ${isScroll ? "" :"bg-lightBackground shadow-sm bg-opacity-50 dark:border dark:border-primaryText/50 dark:bg-transparent"}`}>
                ...
                border border-gray-500 rounded-full ml-4 font-Ovo dark:border-primaryText/50' >
                        Contact
             ...
             w-64 z-50 h-screen bg-lightBackground transition duration-500 dark:bg-darkHover dark:text-primaryText'
